...
const oldDropdown = `                      <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} className="space-y-4">
...
const newDropdown = `                      <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} className="space-y-4">
                        {uniqueCands.length > 0 && !isGroup && (
                          <div>
                            ...
                            >
                              <option value="">Select a registered candidate…</option>
                              {uniqueCands.map(c => {
                                // check if this candidate already has an approved/pending topic for this programme
