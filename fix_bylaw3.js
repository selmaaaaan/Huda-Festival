...
let limitObj = { stage: 4, nonStage: 5 };
            if (settings && settings.categoryItemLimits) {
                ...
                if (catKey.includes('ULA') || catKey.includes('\u016AL\u0100') || catKey.includes('ŪLĀ')) catKey = 'E_ŪLĀ';
                if (catKey.includes('ALIYAH') || catKey.includes('\u0100LIYAH') || catKey.includes('ĀLIYAH')) catKey = 'EĀLIYAH';
