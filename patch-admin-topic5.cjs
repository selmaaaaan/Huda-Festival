...
// 5. Attachment in payload
code = code.replace("topic: topicForm.topic,", "topic: topicForm.topic,\n            attachment: topicForm.attachment,");
code = code.replace("topic: topicForm.topic }", "topic: topicForm.topic, attachment: topicForm.attachment }"); // for PATCH

fs.writeFileSync('admin-hudafestival-main/src/pages/TeamTopicRegistrationPage.jsx', code);
console.log('Patched cleanly again.');
